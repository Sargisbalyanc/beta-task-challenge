...
from articles.views import ArticleDetailAPIView, ArticleListCreateAPIView, TagDetailAPIView, TagListCreateAPIView
...
urlpatterns = [
    ...
    path(
        "api/tags/<int:pk>/", TagDetailAPIView.as_view(), name="tag_detail"
    ),
]
